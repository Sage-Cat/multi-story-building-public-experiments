...
This repository is the privacy-first public surface for the Multi-Story Building
(MSB) research series. It may contain only public-safe documentation, scripts,
schemas, and manifest-approved sanitized dataset bundles.

## Evidence and privacy

- The campaign is planned and unexecuted unless a reviewed public artifact says
  otherwise. Never fabricate measurements, results, participants, deployments,
  or empirical claims.
